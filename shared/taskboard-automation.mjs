...
export function buildTaskboardAutomationPrompt(request) {
  ...
  const candidateInstructions = [
    "从返回的 todo 中只选择依赖已完成的任务：relations.blockedBy 为空，或其中每个依赖的 status 都严格等于 done。无依赖的 todo 仍可并行处理。若有 todo 但全部被未完成依赖阻塞，本轮直接结束，不暂停自动化，也不创建或打开新的任务会话。",
